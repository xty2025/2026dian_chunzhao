...
def plot_history(history: dict, output_dir: Path) -> None:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(output_dir / "gdn_loss_curve.png", dpi=200)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(output_dir / "gdn_accuracy_curve.png", dpi=200)
    plt.close()
...
def main() -> None:
    ...
    best_val_acc = -1.0
    best_model_path = output_dir / "gdn_best.pt"
    ...
    print(f"saved_plots={[str(output_dir / 'gdn_loss_curve.png'), str(output_dir / 'gdn_accuracy_curve.png')]}")
